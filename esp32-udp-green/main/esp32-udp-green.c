...
#define AP_SSID "ESP32_AP_GREEN"
#define AP_PASSWORD "0123" 
#define AP_MAX_CONN 5
#define AP_CHANNEL 0
#define STA_SSID "ESP32_AP_BLUE"
#define STA_PASSWORD "0123"

static const char *TAG = "UDP GREEN";
static const char *payload = "Message from GREEN ESP32 UDP Client";

#define BROADCAST_CLIENT_DEST_IP "192.168.1.255" // Class C Broadcast address
#define BROADCAST_UDP_CLIENT_DEST_PORT 2000

// When connecting to a router, using STA mode, the IP addresses are the following
